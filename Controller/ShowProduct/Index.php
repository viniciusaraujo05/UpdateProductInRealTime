...
use Goit\ShowProductHome\Model\Config\Source\Config;
...
class Index extends \Magento\Framework\App\Action\Action
{
     ...
     * @param Config $config The product list object.
    ...
    {
        $productId = $this->config->getSelectedProducts();
        ...
        $productData = [
            ...
            'timeUpdate' => $this->config->getTimeUpdate()
        ];
